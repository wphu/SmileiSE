...
def get_axis_limits(ax, x_scale=-0.13, y_scale=1.11):
...
ax1_double.legend(lines1 + lines2, labels1 + labels2, fontsize = legend_fontsize)
#ax1.legend(fontsize = 8)
ax1.grid(True)
ax1.annotate(r"$\mathbf{(a)}$ Ion, Exc and CX of D", xy=get_axis_limits(ax1), annotation_clip=False)
...
ax1.grid(True)
ax1.annotate(r"$\mathbf{(b)}$ Ionization of C", xy=get_axis_limits(ax1), annotation_clip=False)
...
ax1.set_xlim((0, 200))
#ax1.set_ylabel(r'$T_e \ (eV)$')
ax1.set_ylabel("Cross Section $\mathrm{(m^2)}$", fontsize = 22)

#ax1.legend(fontsize = 8)
ax1.grid(True)
ax1.annotate(r'$\mathbf{(c)}$ Excitation of C', xy=get_axis_limits(ax1), annotation_clip=False)
...
#ax1.legend(fontsize = 8)
ax1.grid(True)
ax1.annotate(r'$\mathbf{(d)}$ Excitation of $\mathrm{C^+}$', xy=get_axis_limits(ax1), annotation_clip=False)
...
#ax1.legend(fontsize = 8)
ax1.grid(True)
ax1.annotate(r'$\mathbf{(e)}$ Excitation of $\mathrm{C^{+2}}$', xy=get_axis_limits(ax1), annotation_clip=False)
...
#ax1.legend(fontsize = 8)
ax1.grid(True)
ax1.annotate('$\mathbf{(f)}$ Excitation of $\mathrm{C^{+3}}$', xy=get_axis_limits(ax1), annotation_clip=False)

ax1.annotate('$T_e \ \mathrm{(eV)}$', xy=get_axis_limits(ax1, -0.4, -0.3), fontsize = 22, annotation_clip=False)
