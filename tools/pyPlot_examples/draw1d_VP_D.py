...
sp_temp1.yaxis.set_major_formatter(yformatter)
cf_temp1=sp_temp1.plot(x_axis, P0, marker = '8', label = r'$\mathrm{Normalized\ potential}$')
cf_temp1=sp_temp1.plot(x_axis, V0, marker = '^', label = r'$\mathrm{Normalized\ D^+\ ion\ velocity}$')
